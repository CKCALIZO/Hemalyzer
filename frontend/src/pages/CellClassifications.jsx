                ...
                <div className="max-w-7xl mx-auto w-full">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-amber-700">
                                    This page displays only abnormal cells detected by the ConvNeXt model. Normal WBCs, RBCs, and Platelets are automatically filtered out. 
                    ...
                    <div className="mt-6 bg-slate-50 border border-slate-200 p-4 rounded-lg">
                        ...
                        <p className="text-sm text-slate-600 mt-1">
                            ...
                            and confirmed with additional confirmatory tests before any decisions.
                        </p>
                    </div>
                </div>
                </main>
